...
public class OutboxEvent {
    ...
    //StockFailedEvent, StockDecreasedEvent, StockIncreasedEvent
    
    @Column(columnDefinition = "TEXT")
    private String payload; //JSON

    // CDC (Debezium) polling'in yerini aldığı için artık kullanılmıyor.
    // private String errorMessage; // Hata varsa, ne hatası var ?
    // private int retryCount; // Kaç kere denendim ?
